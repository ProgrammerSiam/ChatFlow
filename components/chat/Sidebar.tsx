    ...
    return (
      <aside className="w-18 sm:w-20 h-full rounded-[24px] bg-[#FAFAFA] dark:bg-card border border-slate-200/80 dark:border-border/70 p-3 flex flex-col justify-between items-center shadow-xs select-none shrink-0 transition-all duration-300 relative z-20">
        ...
        <div className="flex flex-col items-center gap-3 w-full">
          ...
          {/* Quick Action Icons: Home, Search, New Chat & New Group */}
          <div className="flex flex-col gap-2 pt-0.5">
            <CoolTooltip content="Landing Page" side="right">
              <Link
                href="/"
    ...
    <aside className="w-full md:w-80 lg:w-84 h-full rounded-[24px] bg-[#FAFAFA] dark:bg-card border border-slate-200/80 dark:border-border/70 p-3.5 sm:p-4 flex flex-col justify-between shadow-xs select-none shrink-0 transition-all duration-300 relative z-20">
      ...
      <div className="flex flex-col gap-3.5">
        ...
        <div className="flex items-center justify-between px-1">
          ...
          {/* Header Action Buttons: Home Landing Link & Collapse Sidebar */}
          <div className="flex items-center gap-1.5">
            <CoolTooltip content="Landing Page" side="bottom">
              <Link
                href="/"
                className="flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200/80 dark:border-border/70 text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-white dark:hover:bg-muted transition-all cursor-pointer shadow-2xs hover:scale-105 active:scale-95"
                title="Go to Landing Page"
              >
