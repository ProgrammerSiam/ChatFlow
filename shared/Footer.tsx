      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-14">
        ...
        <div className="flex flex-col gap-10 xl:flex-row xl:items-start xl:justify-between">
          ...
          <div className="xl:w-1/3">
            <div className="xl:w-86 xl:shrink-0 space-y-5">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base leading-relaxed">
                All-in-One Real-Time Chat & Collaboration Platform for Teams and Individuals – Centralize conversations, group channels, and instant search with zero-latency Socket.io sync.
              </p>
          ...
          <div className="grid flex-1 grid-cols-2 gap-x-10 gap-y-10 lg:grid-cols-4 xl:gap-x-16">
            {/* Column 1: Resources */}
            <div>
              <h3 className="text-slate-900 dark:text-white text-base font-bold">Resources</h3>
              <ul className="mt-5 space-y-3">
                <li><Link className="text-slate-500 dark:text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 text-sm transition-colors" href="/login">Get Started</Link></li>
                <li><a className="text-slate-500 dark:text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 text-sm transition-colors" href="#faq">FAQ</a></li>
                <li><a className="text-slate-500 dark:text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 text-sm transition-colors" href="https://frontend-task-chatapp.onrender.com/docs" target="_blank" rel="noopener noreferrer">REST API Reference</a></li>
                <li><a className="text-slate-500 dark:text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 text-sm transition-colors" href="#demo">Live Sandbox</a></li>
              </ul>
            </div>

            {/* Column 2: Useful Links */}
            <div>
              <h3 className="text-slate-900 dark:text-white text-base font-bold">Useful Links</h3>
              <ul className="mt-5 space-y-3">
                <li><a className="text-slate-500 dark:text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 text-sm transition-colors" href="#how-it-works">Process Flow</a></li>
                <li><a className="text-slate-500 dark:text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 text-sm transition-colors" href="#features">Features Grid</a></li>
                <li><a className="text-slate-500 dark:text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 text-sm transition-colors" href="#testimonials">Community Reviews</a></li>
                <li><Link className="text-slate-500 dark:text-slate-400 hover:text-purple-600 dark:hover:text-purple-400 text-sm transition-colors" href="/chat">Web App</Link></li>
              </ul>
            </div>

            {/* Column 3: Explore */}
            <div>
              <h3 className="text-slate-900 dark:text-white text-base font-bold">Explore</h3>
              <ul className="mt-5 space-y-3">
                <li><span className="text-slate-500 dark:text-slate-400 text-sm">Direct Messaging</span></li>
                <li><span className="text-slate-500 dark:text-slate-400 text-sm">Group Channels</span></li>
                <li><span className="text-slate-500 dark:text-slate-400 text-sm">Admin Role Gating</span></li>
                <li><span className="text-slate-500 dark:text-slate-400 text-sm">Reverse Pagination</span></li>
              </ul>
            </div>

            {/* Column 4: Capabilities */}
            <div>
              <h3 className="text-slate-900 dark:text-white text-base font-bold">Capabilities</h3>
              <ul className="mt-5 space-y-3">
                <li><span className="text-slate-500 dark:text-slate-400 text-sm">Optimistic Delivery</span></li>
                <li><span className="text-slate-500 dark:text-slate-400 text-sm">Socket.io Handshake</span></li>
                <li><span className="text-slate-500 dark:text-slate-400 text-sm">Gap-Fill Invalidation</span></li>
                <li><span className="text-slate-500 dark:text-slate-400 text-sm">Bearer Authentication</span></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 pt-6 border-t border-slate-200/80 dark:border-border/60">
          <div>
            <h3 className="text-slate-900 dark:text-white text-sm font-bold uppercase tracking-wider">REST Endpoints Contract</h3>
          ...
          <div>
            <h3 className="text-slate-900 dark:text-white text-sm font-bold uppercase tracking-wider">Real-Time Event Handlers</h3>
            <ul className="mt-4 space-y-2.5 grid md:grid-cols-2 md:gap-x-4 text-xs font-mono text-slate-500 dark:text-slate-400">
        ...
        <div className="border-t border-slate-200/80 dark:border-border/60 pt-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between text-xs sm:text-sm text-slate-500 dark:text-slate-400">
          ...
          <div className="flex items-center gap-2">
            <span>Built with Next.js 16, React 19, Socket.IO &amp; TanStack Query</span>
          </div>
        </div>
      </div>
    </footer>
