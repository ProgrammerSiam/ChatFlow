...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-gradient-to-b from-[#FAF8FF] via-[#F6F3FE] to-[#F1EEFB] dark:from-[#090810] dark:via-[#0E0C1B] dark:to-[#07060D] text-foreground overflow-hidden">
      ...
      <div className="absolute inset-x-0 -bottom-20 sm:-bottom-28 pointer-events-none select-none flex justify-center overflow-hidden z-0">
        <Image
          src="/assets/hero-radial-glow.png"
          alt="Hero Radial Glow"
          width={2400}
          height={1000}
          className="w-full max-w-7xl h-auto object-cover opacity-90 dark:opacity-50"
          priority
        />
      </div>

      {/* Ambient background glows */}
      <div className="pointer-events-none absolute -top-40 -left-40 h-[500px] w-[500px] rounded-full bg-purple-400/20 dark:bg-purple-600/15 blur-[130px]" />
      <div className="pointer-events-none absolute -bottom-40 -right-40 h-[500px] w-[500px] rounded-full bg-indigo-400/20 dark:bg-indigo-600/15 blur-[130px]" />
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center p-4 sm:p-6 my-auto">
        <div className="relative w-full max-w-[440px]">
          <div className="relative w-full rounded-[32px] border border-slate-200/80 dark:border-border/80 bg-white/95 dark:bg-card/95 p-7 sm:p-9 shadow-2xl shadow-purple-500/5 backdrop-blur-2xl text-card-foreground overflow-hidden">
